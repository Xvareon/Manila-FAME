<template>
  <div class="card p-4 shadow-sm">
    <h4 class="mb-3">Step 3: Summary & Confirmation</h4>
    ...
    <div class="d-flex justify-content-between mt-4">
      <button class="btn btn-secondary" @click="store.prevStep()" :disabled="loading">Back</button>

      <button class="btn btn-success" @click="submitRegistration" :disabled="loading">
...
async function submitRegistration() {
  ...
  try {
    ...
    Object.entries(store.company).forEach(([key, value]) => formData.append(`company[${key}]`, value));
